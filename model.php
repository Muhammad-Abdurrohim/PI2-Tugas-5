...
// tabel mahasiswa
 public function insert_mhs($nama, $semester, $alamat, $telepon, $email, $id)
{
  $sql = "INSERT INTO tbl_mhs (nama, semester, alamat, telepon, email, id) 
  VALUES ('$nama','$semester', '$alamat', '$telepon', '$email', '$id')";
  $this->conn->query($sql);
}
...
public function update_mhs($nama, $semester, $alamat, $telepon, $email, $id)
{
   $sql = "UPDATE tbl_mhs SET nama='$nama', semester='$semester', alamat='$alamat', telepon='$telepon', email='$email' WHERE id='$id'";
   $this->conn->query($sql);
}
